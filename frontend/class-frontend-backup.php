        ...
        public function show_store_address( $atts ) {
            ...
            if ( $atts['phone'] || $atts['fax'] || $atts['email'] || $atts['url'] ) {
                ...
                if ( $atts['phone'] && $phone ) {
                   ...
                   $content .= esc_html( $wpsl->i18n->get_translation( 'phone_label', __( 'Phone', 'wpsl' ) ) ) . ': <a href="tel:'.$contact_details['phone'].'">' . $contact_details['phone']  . '</a><br/>';
                }
                ...
                if ( $atts['email'] && $email ) {
                    ...
                    $content .= esc_html( $wpsl->i18n->get_translation( 'email_label', __( 'Email', 'wpsl' ) ) ) . ': <a href="mailto:'.$contact_details['email'].'">' . $contact_details['email'] . '</a><br/>';
                }
                ...
                if ( $atts['url'] && $store_url = get_post_meta( $atts['id'], 'wpsl_url', true ) ) {
                    ...
                    //$content   .= esc_html( $wpsl->i18n->get_translation( 'url_label', __( 'Url', 'wpsl' ) ) ) . ': <a ' . $new_window . ' href="' . esc_url( $store_url ) . '"> Virtual Showroom </a><br/>';
 		    $content   .= '<iframe  width="100%" height="600" src="' . esc_url( $store_url ) . '" frameborder="0" allowfullscreen allow="xr-spatial-tracking"> Virtual Showroom </iframe><br/>';
